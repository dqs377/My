...
cc.Class({
    ...
    onLoad: function () {
        ...
        clickEventHandler.component = "xia";// 这个是代码文件名
    ...
    callback: function (event, customEventData) {
        ...
        if(this.player.y <= 250 && this.player.y > 0){
            if(!(this.player.x==150 && this.player.y == 50))
            if(!(this.player.x==250 && this.player.y == 100))
            if(!(this.player.x==0 && this.player.y == 100))
            if(!(this.player.x==150 && this.player.y == 100))
            if(!(this.player.x==200 && this.player.y == 150))
            if(!(this.player.x==50 && this.player.y == 150))//不能向下的格子
            if(!(this.player.x==100 && this.player.y == 150))
            if(!(this.player.x==150 && this.player.y == 200))
            if(!(this.player.x==50 && this.player.y == 250))
            {
                this.player.y -= 50;//向下移动一格
            }
        }
